...
final class CafeteriaMyReviewCell: UITableViewCell, ReuseIdentifying {
    ...
    func configureCafeteriaMyReviewCell(with myReview: CafeteriaMyReviewSection) {
